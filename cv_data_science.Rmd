---
title: "Dave Gruenewald's resume"
...
![Dave Gruenewald](https://avatars1.githubusercontent.com/u/20053023?s=460&u=f8e821e7454baf0c3873afa7edbad801febbb69f&v=4){width=80%}


Contact Info {#contact}
--------------------------------------------------------------------------------

- <i class="fa fa-envelope"></i> dave.gruenewald@gmail.com
- <i class="fa fa-phone"></i> +1 (270) 485-1531
- <i class="fa fa-linkedin"></i> [linkedin.com/in/dgruenewald](www.linkedin.com/in/dgruenewald)
- <i class="fa fa-github"></i> [github.com/dgruenew](https://github.com/yulijia)
- <i class="fa fa-stack-overflow"></i> [stackoverflow.com/cv/dgruenew](https://stackoverflow.com/users/6535514/dave-gruenewald)
...
Dave Gruenewald {#title}
--------------------------------------------------------------------------------

Skills and Training {data-icon=info data-concise=true}
--------------------------------------------------------------------------------

### Programming/Software

R, SQL, Spark, RStudio Server, RStudio Connect, R Shiny, Package Development, 
Git, GitLab, AWS S3, JupyterHub, DataRobot, Excel, REDCap (Research Electronic 
Data Capture), SharePoint, ArcGIS, Omniture

### Skills

Multiple regression analysis, supervised and unsupervised machine learning 
methods (regression, random forest decision trees, k-means, hierarchical 
clustering), R package development, PCA, ANOVA, data query, data visualizations

### Work Groups

Data Science User Group (founded at Children’s Healthcare of Atlanta), R-User 
Group, Statistical Advisory Group, Evaluation Community of Practice
